...
const authenticateToken = async (req: Request & { user?: any }, res: Response, next: NextFunction) => {
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/projects", authenticateToken, requireRole(['admin', 'district_officer', 'block_officer']), async (req: any, res) => {
    try {
  ...
  app.post("/api/reports", authenticateToken, requireRole(['admin', 'district_officer', 'block_officer']), async (req: any, res) => {
    try {
